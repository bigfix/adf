...
(function() {
    ...
    dojo.addOnLoad(function() {
		...
		window.onerror = function(message, uri, line) {
			...
			var errorImg = dojo.create('img', {src: 'i_message_critical.png',  style:{'float':'left'}});
			...
			var errorTextInnerDiv = dojo.create('div', {style: {'float': 'left', marginBottom: '30px', wordWrap: 'break-word'}});
			...
			var errorLink = dojo.create("a", { href:"" , title: temui.dojo.l10n.showLog, innerHTML: temui.dojo.l10n.showLog });
