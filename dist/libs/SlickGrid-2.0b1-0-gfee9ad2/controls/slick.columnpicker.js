(function ($) {
	...
	try {
		forceFit = temui.l10n.forceFitColumns;
		synchResize = temui.l10n.synchronousResizing;
	} catch(e) {
		forceFit = "Force Fit Columns";
		synchResize = "Synchronous Resizing";
	}
  ...
  function SlickColumnPicker(columns, grid, options) {
    ...
    function handleHeaderContextMenu(e, args) {
      ...
      $("<label for='autoresize'>" + forceFit + "</label>").appendTo($li);
      ...
      $("<label for='syncresize'>" + synchResize + "</label>").appendTo($li);
